// AsyncIterable over the connect-free streaming bridge (createStream -> streamReceive -> closeStream).
// Same termination logic as src/grpc/transport_native.ts: the native module rejects streamReceive
...
// streamAsyncIterable starts a server-streaming method and yields each parsed protojson response.
