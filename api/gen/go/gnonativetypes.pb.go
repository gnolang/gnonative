...
type EstimateTxFeesResponse struct {
	...
	StorageDelta int64 `protobuf:"zigzag64,4,opt,name=storage_delta,json=gas_wanted,proto3" json:"storage_delta,omitempty"`
	// The estimated storage fee for the transaction. Can be negative for "unlock"
	StorageFee    *Coin `protobuf:"bytes,5,opt,name=storage_fee,json=gas_fee,proto3" json:"storage_fee,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_gnonativetypes_proto_rawDesc = "" +
	...
	"\tupdate_tx\x18\x05 \x01(\bR\bupdateTx\"\xe4\x01\n" +
	...
	"\rstorage_delta\x18\x04 \x01(\x12R\n" +
	"gas_wanted\x129\n" +
	"\vstorage_fee\x18\x05 \x01(\v2\x1b.land.gno.gnonative.v1.CoinR\agas_fee\";\n" +
