...
func (x *EstimateTxFeesRequest) GetPriceSecurityMargin() uint32 {
	if x != nil {
...
const file_gnonativetypes_proto_rawDesc = "" +
	...
	"\tupdate_tx\x18\x05 \x01(\bR\bupdateTx\"\x86\x01\n" +
	"\x16EstimateTxFeesResponse\x12\x17\n" +
	"\atx_json\x18\x01 \x01(\tR\x06txJson\x12\x1d\n" +
	"\n" +
	"gas_wanted\x18\x02 \x01(\x12R\tgasWanted\x124\n" +
	"\agas_fee\x18\x03 \x01(\v2\x1b.land.gno.gnonative.v1.CoinR\x06gasFee\";\n" +
