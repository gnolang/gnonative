...
export const ActivateAccountRequest = proto3.makeMessageType(
  "land.gno.gnonative.v1.ActivateAccountRequest",
  () => [
    { no: 1, name: "name_or_bech32", kind: "scalar", T: 9 /* ScalarType.STRING */ },
  ],
);
 ...
 */
export const GetActivatedAccountRequest = proto3.makeMessageType(
  "land.gno.gnonative.v1.GetActivatedAccountRequest",
  () => [
    { no: 1, name: "address", kind: "scalar", T: 12 /* ScalarType.BYTES */ },
  ],
);
 ...
 */
export const GetActivatedAccountResponse = proto3.makeMessageType(
  "land.gno.gnonative.v1.GetActivatedAccountResponse",
  () => [
    { no: 1, name: "key", jsonName: "key_info", kind: "message", T: KeyInfo },
    { no: 2, name: "has_password", kind: "scalar", T: 8 /* ScalarType.BOOL */ },
  ],
 ...
 */
export const MakeTxResponse = proto3.makeMessageType(
  "land.gno.gnonative.v1.MakeTxResponse",
  () => [
 ...
 */
export const SignTxRequest = proto3.makeMessageType(
  "land.gno.gnonative.v1.SignTxRequest",
  () => [
    { no: 1, name: "tx_json", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 2, name: "address", kind: "scalar", T: 12 /* ScalarType.BYTES */ },
 ...
 */
export const SignTxResponse = proto3.makeMessageType(
  "land.gno.gnonative.v1.SignTxResponse",
  () => [
...
export const BroadcastTxCommitRequest = proto3.makeMessageType(
  "land.gno.gnonative.v1.BroadcastTxCommitRequest",
  () => [
    { no: 1, name: "signed_tx_json", jsonName: "tx_json", kind: "scalar", T: 9 /* ScalarType.STRING */ },
  ],
);
 ...
 */
export const BroadcastTxCommitResponse = proto3.makeMessageType(
  "land.gno.gnonative.v1.BroadcastTxCommitResponse",
  () => [
    { no: 1, name: "result", kind: "scalar", T: 12 /* ScalarType.BYTES */ },
  ],
);
 ...
 */
export const AddressFromMnemonicRequest = proto3.makeMessageType(
 ...
 */
export const AddressFromMnemonicResponse = proto3.makeMessageType(
